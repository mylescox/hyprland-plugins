...
A plugin to add animated pill grabbers to Hyprland windows. Click and drag on the pill to move a window.
...
# Features
 ...
 - Pills intelligently dodge occluding windows and each other.
