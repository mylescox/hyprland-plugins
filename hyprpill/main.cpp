...
APICALL EXPORT PLUGIN_DESCRIPTION_INFO PLUGIN_INIT(HANDLE handle) {
    ...
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_width_inactive", Hyprlang::INT{26});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_height_inactive", Hyprlang::INT{4});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_radius_inactive", Hyprlang::INT{2});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_width_hover", Hyprlang::INT{150});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_height_hover", Hyprlang::INT{12});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:hover_hitbox_width", Hyprlang::INT{40});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:hover_hitbox_height", Hyprlang::INT{20});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:hover_hitbox_offset_y", Hyprlang::INT{-9});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:dodge_occluder_margin", Hyprlang::INT{4});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:click_hitbox_width", Hyprlang::INT{35});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:click_hitbox_height", Hyprlang::INT{15});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:click_hitbox_offset_y", Hyprlang::INT{-4});
    ...
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:hover_cursor", Hyprlang::STRING{"hand1"});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:grab_cursor", Hyprlang::STRING{"hand2"});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:drag_pixel_threshold", Hyprlang::INT{8});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:double_click_timeout", Hyprlang::INT{250});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_color_active", Hyprlang::INT{*configStringToInt("rgba(ffffff77)")});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_color_inactive", Hyprlang::INT{*configStringToInt("rgba(777777FF)")});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_color_hover", Hyprlang::INT{*configStringToInt("rgba(ffffffAA)")});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_color_pressed", Hyprlang::INT{*configStringToInt("rgba(ffffffff)")});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_opacity_active", Hyprlang::FLOAT{1.F});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_opacity_inactive", Hyprlang::FLOAT{0.2F});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_offset_y_active", Hyprlang::INT{20});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_offset_y_inactive", Hyprlang::INT{8});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:anim_duration_hover", Hyprlang::INT{100});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:anim_duration_press", Hyprlang::INT{120});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:anim_easing", Hyprlang::STRING{"easeOutExpo"});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:geometry_lerp_speed", Hyprlang::FLOAT{150.F});
    ...
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_precedence_over_border", Hyprlang::INT{1});
