...
APICALL EXPORT PLUGIN_DESCRIPTION_INFO PLUGIN_INIT(HANDLE handle) {
    ...
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_width_inactive", Hyprlang::INT{84});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_height_inactive", Hyprlang::INT{10});
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:pill_radius_inactive", Hyprlang::INT{10});
    ...
    HyprlandAPI::addConfigValue(PHANDLE, "plugin:hyprpill:double_click_timeout", Hyprlang::INT{400});
